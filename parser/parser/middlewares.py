...
from cfscrape import get_tokens, get_cookie_string
import logging
class ProxiesDownloaderMiddleware(object):

    def process_request(self, request, spider):
        
        request.meta['proxy'] = 'root@http://free-proxy.cz/ru/'

class CreativeProMiddleware:
    


    def process_request(self, request, spider):
        print ('request====', request)
        request.headers = 'fgdfdf'
        print ('request12121====', request)
...
class CreativeMiddleware:
    ...
    def process_response(self, request, response, spider):
        ...
        request.cookies.update(my_cookies)
        return request
